        ...
        return (
            <View style={[styles.curbg]}>
                ...
                <View style={[styles.curview_40]}>
                    ...
                    <Text style={[styles.text_right]}>测试数据</Text>
                </View>
                <View style={[styles.view_line]}/>
                <View style={[styles.curview_40]}>
                    <Text style={[styles.text_left]}>所属经营中心</Text>
                    <Text style={[styles.text_right]}>无锡市新吴区新安站</Text>
                </View>
                <View style={[styles.view_line]}/>
                <View style={[styles.curview_40]}>
                    <Text style={[styles.text_left]}>所属网点</Text>
                    <Text style={[styles.text_right]}>无锡市新吴区新安</Text>
                </View>
                <View style={[styles.view_line]}/>
                <View style={[styles.curview_40]}>
                ...
                <View style={[styles.curview_40]}>
                    ...
                    <Text style={[styles.text_right]}>12345678901</Text>
                </View>
                <View style={[styles.view_line]}/>
                <View style={[styles.curview_40]}>
                    <Text style={[styles.text_left]}>身份证号</Text>
                    <Text style={[styles.text_right]}>320382199002201099</Text>
                </View>
                <View style={[styles.view_line]}/>
                <View style={[styles.curview_40]}>
