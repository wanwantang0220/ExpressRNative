...
import {
    View, Animated, Dimensions, Platform, StyleSheet, Text, TouchableHighlight, Easing,
    TouchableOpacity
} from 'react-native';
...
export default class DialogSelected extends PureComponent {
                    ...
                    <Animated.View style={[{
                        ...
                        transform: [{
                            translateY: this.state.offset.interpolate({
                                inputRange: [0, 1],
                                outputRange: [height, (this.state.aHeight +  120)]
                            }),
                        }]
                    }]}>
    ...
    renderItem(item, i) {
        return (
            <View style={styles.tipContentView}>
                <View style={{height: 0.2, backgroundColor: '#a9a9a9', width: aWidth}}/>
                <TouchableOpacity
                    key={i}
